...
// include: C:\Users\RUNNER~1\AppData\Local\Temp\tmp8yjylktx.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './RaylibGameJam2024.data';
      var REMOTE_PACKAGE_BASE = 'RaylibGameJam2024.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./RaylibGameJam2024.data');

      };
      Module['addRunDependency']('datafile_./RaylibGameJam2024.data');
    ...
    loadPackage({"files": [{"filename": "/resources/README.txt", "start": 0, "end": 52}, {"filename": "/resources/asset.png", "start": 52, "end": 167}, {"filename": "/resources/bg.png", "start": 167, "end": 46285}, {"filename": "/resources/player_idle.png", "start": 46285, "end": 46398}, {"filename": "/resources/player_run0.png", "start": 46398, "end": 46521}, {"filename": "/resources/player_run1.png", "start": 46521, "end": 46643}, {"filename": "/resources/player_run2.png", "start": 46643, "end": 46767}, {"filename": "/resources/player_run3.png", "start": 46767, "end": 46889}, {"filename": "/resources/player_run4.png", "start": 46889, "end": 46998}, {"filename": "/resources/tileset.png", "start": 46998, "end": 47107}], "remote_package_size": 47107});

  })();

// end include: C:\Users\RUNNER~1\AppData\Local\Temp\tmp8yjylktx.js
...
var ASM_CONSTS = {
  30688: () => { if (document.fullscreenElement) return 1; },  
 30734: () => { return document.getElementById('canvas').width; },  
 30786: () => { return parseInt(document.getElementById('canvas').style.width); },  
 30854: () => { document.exitFullscreen(); },  
 30881: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 30954: () => { if (document.fullscreenElement) return 1; },  
 31000: () => { return document.getElementById('canvas').width; },  
 31052: () => { return screen.width; },  
 31077: () => { document.exitFullscreen(); },  
 31104: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 31237: () => { return window.innerWidth; },  
 31263: () => { return window.innerHeight; },  
 31290: () => { if (document.fullscreenElement) return 1; },  
 31336: () => { return document.getElementById('canvas').width; },  
 31388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31456: () => { if (document.fullscreenElement) return 1; },  
 31502: () => { return document.getElementById('canvas').width; },  
 31554: () => { return screen.width; },  
 31579: () => { return window.innerWidth; },  
 31605: () => { return window.innerHeight; },  
 31632: () => { if (document.fullscreenElement) return 1; },  
 31678: () => { return document.getElementById('canvas').width; },  
 31730: () => { return screen.width; },  
 31755: () => { document.exitFullscreen(); },  
 31782: () => { if (document.fullscreenElement) return 1; },  
 31828: () => { return document.getElementById('canvas').width; },  
 31880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 31948: () => { document.exitFullscreen(); },  
 31975: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 32033: () => { return screen.width; },  
 32058: () => { return screen.height; },  
 32084: () => { return window.screenX; },  
 32111: () => { return window.screenY; },  
 32138: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 32191: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 32262: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 32319: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 32575: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 32646: () => { if (document.fullscreenElement) return 1; },  
 32692: () => { return window.innerWidth; },  
 32718: () => { return window.innerHeight; },  
 32745: () => { if (document.pointerLockElement) return 1; }
};
